...
type mockGitCli struct {
	...
	CommitFunc            func(workdir, message string) (string, error)
	MergeFunc             func(workdir, ref, message string) (string, error)
...
func (m *mockGitCli) Commit(workdir, message string) (string, error) {
	if m.CommitFunc != nil {
		return m.CommitFunc(workdir, message)
	}
	return "", nil
}

func (m *mockGitCli) Merge(workdir, ref, message string) (string, error) {
	if m.MergeFunc != nil {
		return m.MergeFunc(workdir, ref, message)
	}
	return "", nil
}
