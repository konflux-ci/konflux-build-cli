...
var ParamsConfig = map[string]common.Parameter{
	...
	"revision": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "Revision to checkout. (branch, tag, sha, ref, etc...)",
	},
	"refspec": {
		Name:         "refspec",
	...
	"submodule-paths": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "Comma-separated list of specific submodule paths to initialize and fetch. Only submodules in the specified directories and their subdirectories will be fetched. Empty string fetches all submodules. Parameter 'submodules' must be set to 'true' to make this parameter applicable.",
	},
	"depth": {
		Name:         "depth",
	...
	"subdirectory": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "source",
		Usage:        "Subdirectory inside the `output` Workspace to clone the repo into.",
	},
	"sparse-checkout-directories": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "Define the directory patterns to match or exclude when performing a sparse checkout.",
	},
	"delete-existing": {
	...
	"http-proxy": {
		Name:         "http-proxy",
		EnvVarName:   "KBC_GIT_CLONE_HTTP_PROXY",
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "HTTP proxy server for non-SSL requests.",
	},
	"https-proxy": {
		Name:         "https-proxy",
		EnvVarName:   "KBC_GIT_CLONE_HTTPS_PROXY",
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "HTTPS proxy server for SSL requests.",
	},
	"no-proxy": {
		Name:         "no-proxy",
		EnvVarName:   "KBC_GIT_CLONE_NO_PROXY",
		TypeKind:     reflect.String,
		DefaultValue: "",
	...
	"verbose": {
		Name:         "verbose",
		EnvVarName:   "KBC_GIT_CLONE_VERBOSE",
		TypeKind:     reflect.Bool,
		DefaultValue: "false",
		Usage:        "Log the commands that are executed during git-clone's operation.",
	},
	"user-home": {
		Name:         "user-home",
	...
	"merge-target-branch": {
		...
		TypeKind:     reflect.Bool,
		DefaultValue: "false",
		Usage:        "Set to true to merge the targetBranch into the checked-out revision.",
	},
	"target-branch": {
		Name:         "target-branch",
	...
	"merge-source-repo-url": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "URL of the repository to fetch the target branch from when mergeTargetBranch is true. If empty, uses the same repository (origin). This allows merging a branch from a different repository.",
	},
	"merge-source-depth": {
...
type Params struct {
	...
	HttpProxy                 string `paramName:"http-proxy"`
	HttpsProxy                string `paramName:"https-proxy"`
	NoProxy                   string `paramName:"no-proxy"`
	Verbose                   bool   `paramName:"verbose"`
	UserHome                  string `paramName:"user-home"`
