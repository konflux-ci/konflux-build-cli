...
var _ ImageRegistry = &QuatRegistry{}

type QuatRegistry struct {
	namespace string
	login     string
	password  string
}

func NewQuatRegistry() ImageRegistry {
	return &QuatRegistry{}
}

func (q *QuatRegistry) Prepare() error {
...
func (q *QuatRegistry) getEnvVar(envVarName string) (string, error) {
...
func (q *QuatRegistry) Start() error {
	return nil
}

func (q *QuatRegistry) Stop() error {
	return nil
}

func (q *QuatRegistry) IsLocal() bool {
	return false
}

func (q *QuatRegistry) GetRegistryDomain() string {
	return "quay.io"
}

func (q *QuatRegistry) GetTestNamespace() string {
	return q.GetRegistryDomain() + "/" + q.namespace + "/"
}

func (q *QuatRegistry) GetCredentials() (string, string) {
	return q.login, q.password
}

func (q *QuatRegistry) GetDockerConfigJsonContent() []byte {
...
func (q *QuatRegistry) CheckTagExistance(repo string, tag string) (bool, error) {
